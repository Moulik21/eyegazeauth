...
class PicturePointsPanel(wx.Panel):
   ...
   def __do_layout(self):
       ...
       sample1Button.Bind(wx.EVT_BUTTON, lambda event: self.openPicturePointsSelectFrame(event, sample1Img, sample1ImgName))
       ...
       sample2Button.Bind(wx.EVT_BUTTON, lambda event: self.openPicturePointsSelectFrame(event, sample2Img, sample2ImgName))
       ...
       sample3Button.Bind(wx.EVT_BUTTON, lambda event: self.openPicturePointsSelectFrame(event, sample3Img, sample3ImgName))
       ...
       sample4Button.Bind(wx.EVT_BUTTON, lambda event: self.openPicturePointsSelectFrame(event, sample4Img, sample4ImgName))
       ...
       sample5Button.Bind(wx.EVT_BUTTON, lambda event: self.openPicturePointsSelectFrame(event, sample5Img, sample5ImgName))
       ...
       sample6Button.Bind(wx.EVT_BUTTON, lambda event: self.openPicturePointsSelectFrame(event, sample6Img, sample6ImgName))
   ...
   def onClick(self, event):
       ...
       if (len(self.selection) == 4):
           ...
           if happySelection.ShowModal() == wx.ID_NO:
               ...
               pswd_file = open(curdir + "/picturepointspassword.txt", "w+")
               pswd_file.seek(0)
               for point in self.selection:
                   print(point)
                   pswd_file.write(str(point)+'\n')
