...
- Fix a status return code issue that authenticated sudo even on wrong password input. - Calin Chirvase
...
- Integration between PAM and eyetracking - Calin Chirvase, Jiyu Liu, Daniel Bishara
